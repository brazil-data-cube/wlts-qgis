...
class WltsQgis:
    ...
    def showHelp(self):
        ...
        qgis.utils.showPluginHelp(packageName="wlts_qgis", filename="index", section="about")
    ...
    def getDate(self):
        ...
        self.dlg.end_date.setDate(self.basic_controls.formatForQDate("2020-01-01"))
    ...
    def initServices(self):
        ...
        self.dlg.service_selection.activated.connect(self.select_service)
